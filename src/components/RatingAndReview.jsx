...
const RatingAndReview = () => {
    ...
    const fetchReviews = async () => {
        try {
            const response = await axios.get('https://capstone-be-1.onrender.com/api/rating/all', {
                headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://capstone-be-1.onrender.com/api/rating/rating', requestData, {
            headers: {
                Authorization: `Bearer ${user.token}`, // Include the token in the request headers
            },
        })
